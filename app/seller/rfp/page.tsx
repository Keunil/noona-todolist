...
export default function SellerRFPPage() {
  ...
  const sellerServices = MA_SERVICES.filter((s) => s.category === "seller" || s.category === "common")
                ...
                <CardContent>
                  ...
                  {service.category !== "common" && (
                    <Badge variant="secondary" className="mt-2">
                      {service.category === "seller" ? "매도자 전용" : "매수자 전용"}
                    </Badge>
                  )}
                </CardContent>
              </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="revenue">최근 연매출</Label>
                  <Input
                    id="revenue"
                    placeholder="예: 50억원"
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t">
                ...
                <div>
                  <p className="text-sm text-gray-500">최근 연매출</p>
